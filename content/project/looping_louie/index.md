...
Additionally the introduction of a control unit gives one player or supervisor power of the rotational speed and direction of the air plane arm, enabling targeted attacks on a players chips.
...
Reversing the motor polarity causes a big current surge that might cause the power supply to shut down - non-issue in praxis.
