---
title: Sketchfab
description: This post demonstrates two methods of embedding 3d models using Sketchfab's API.
date: 2024-12-06
tags:
  - 3d
  - sketchfab
...
<!--This is Hugo's shortcode syntax to embed content -->
...
Considering the [initialization & options documentation](https://sketchfab.com/developers/viewer/initialization) it also looks like a lot of interesting settings are locked behind a paywall, like disabling the UI controls.

![some paid only settings](image.png)

They make this very clear on their license options page.
