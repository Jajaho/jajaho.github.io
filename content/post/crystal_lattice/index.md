...
The elegance and power of Fourier's famous integral transformation was probably the single most fascinating thing which I got to know during my studies of electrical engineering. A theorist might note that his function is only a special case of the Laplace transformation, but when it comes to applications, Fourier's transform outshines it manifold. The use of the impulse-/reciprocal space in material science is one particularly fascinating application, as it creates beautiful 3D structures, which help explain the real world.
